...
module Jekyll
  ...
  class SitemapGenerator < Generator
    ...
    def sitemap_url
      @sitemap_config["url"] || 'http://www.example.com'
    end
    ...
    def fill_location(site, page_or_post)
      ...
      loc.text = File.join(sitemap_url, page_or_post.location_on_server)
      loc
    end
    ...
    def pages_with_posts
      @sitemap_config["pages-with-posts"] || PAGES_INCLUDE_POSTS
    end
    
    def posts_included?(name)
      pages_with_posts.include? name
    end
